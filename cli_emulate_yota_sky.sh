...
tc qdisc add dev eth1 parent 1:12 netem delay 5ms
...
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 200kbit ceil 200kbit
tc qdisc add dev eth2 parent 1:12 netem delay 5ms
...
tc class add dev eth3 parent 1:1 classid 1:12 htb rate 300kbit ceil 300kbit
tc qdisc add dev eth3 parent 1:12 netem delay 5ms
