...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 1200kbit ceil 1200kbit
tc qdisc add dev eth1 parent 1:12 netem delay 80ms 50ms 50%
...
tc class add dev eth2 parent 1:1 classid 1:12 htb rate 5000kbit ceil 5000kbit
tc qdisc add dev eth2 parent 1:12 netem delay 10ms 50ms 10%
