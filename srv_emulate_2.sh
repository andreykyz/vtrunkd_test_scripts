...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 3mbit ceil 3mbit
tc qdisc add dev eth1 parent 1:12 netem delay 15ms 1ms 5%
#tc qdisc add dev eth1 parent 1:12 netem delay 15ms 1ms 5% loss 5% 30%
...
tc qdisc add dev eth2 parent 1:12 netem delay 30ms 1ms 5%
#tc qdisc add dev eth2 parent 1:12 netem delay 30ms 1ms 5% loss 5% 30%
...
tc class add dev eth3 parent 1:1 classid 1:12 htb rate 1200kbit ceil 1200kbit
tc qdisc add dev eth3 parent 1:12 netem delay 50ms 1ms 10%
#tc qdisc add dev eth3 parent 1:12 netem delay 50ms 1ms 10% loss 5% 30%
