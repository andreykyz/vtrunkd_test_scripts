...
tc class add dev eth1 parent 1:1 classid 1:12 htb rate 7mbit ceil 7mbit
tc qdisc add dev eth1 parent 1:12 netem delay 20ms 1ms 5%
...
tc class add dev eth3 parent 1:1 classid 1:12 htb rate 10000kbit ceil 10000kbit
tc qdisc add dev eth3 parent 1:12 netem delay 20ms 1ms 10%
